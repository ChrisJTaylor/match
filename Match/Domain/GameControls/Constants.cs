...
public static class Constants
{
    public static class Questions
    {
        ...
        public static readonly string WhichMatchingConditionWouldYouLikeToUse = "Which matching condition would you like to use? (1 = Value, 2 = Suite, 3 = Value and Suite)";
    }
